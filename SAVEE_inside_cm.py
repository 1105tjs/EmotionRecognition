...
model = load_model('./SAVEE_insideRmv_model')
...
# 분류 보고서 출력
class_names = ['JOY', 'SADNESS', 'FEAR', 'DISGUST', 'ANGER']
print("\nSAVEE-insideOut Classification Report:")
...
plt.ylabel('Actual')
plt.title('SAVEE-insideOut Confusion Matrix')
plt.savefig('./SAVEE_insideRmv_cm1.png')
...
plt.ylabel('Actual')
plt.title('SAVEE-insideOut Confusion Matrix')
plt.savefig('./SAVEE_insideRmv_cm2.png')
...
plt.title("SAVEE-insideOut Normalized Confusion Matrix")
plt.savefig('./SAVEE_insideRmv_ncm.png')
