...
model = load_model('./TESS0817_inside')
...
# 분류 보고서 출력
class_names = ['JOY', 'SADNESS', 'FEAR', 'DISGUST', 'ANGER']
print("\nTESS-insideOut Classification Report:")
...
plt.ylabel('Actual')
plt.title('TESS-insideOut Confusion Matrix')
plt.savefig('./TESS_inside_cm1.png')
...
plt.ylabel('Actual')
plt.title('TESS-insideOut Confusion Matrix')
plt.savefig('./TESS_inside_cm2.png')
...
plt.title("TESS-insideOut(Remove) Normalized Confusion Matrix")
plt.savefig('./TESS_insideRmv_ncm.png')
