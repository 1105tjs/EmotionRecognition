...
model = load_model('./EmoDB_insideRmv_model')
...
# 분류 보고서 출력
class_names = ['JOY', 'SADNESS', 'FEAR', 'DISGUST', 'ANGER']
print("\nEmoDB-insideOut Classification Report:")
...
plt.ylabel('Actual')
plt.title('EmoDB-insideOut Confusion Matrix')
plt.savefig('./EmoDB_insideRmv_cm1.png')
...
plt.ylabel('Actual')
plt.title('EmoDB-insideOut Confusion Matrix')
plt.savefig('./EmoDB_insideRmv_cm2.png')
...
plt.title("EmoDB-insideOut(Remove) Normalized Confusion Matrix")
plt.savefig('./EmoDB_insideRmv_ncm.png')
